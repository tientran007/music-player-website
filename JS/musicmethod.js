...
function displayAllSong() {
    ...
    for (let i = 0; i < listsong.length; i++) {
        tbshowallsong.innerHTML += ` <tr class= "trinfosong" >
             ...
             <td class="showinfosong"><img class="imgsong" src="${listsong[i].logosong}" alt=""></td>
...
function addplaylist(index) {
    let song = new SongInPlayList(listsong[index].id, listsong[index].namesong, listsong[index].namesinger, listsong[index].audio, listsong[index].logosong)
...
function playsong(index) {
    ...
    document.getElementById("marquee1").innerHTML = `${listsong[index].namesinger}`;
...
function rewindsong() {
  ...
  function showindexsong() {
   ...
   document.getElementById("inerindexsong").innerHTML = `Song ${indexsong}/ ${totalsong}`
